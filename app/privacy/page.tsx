      ...
      <div className="space-y-8 text-foreground/80 leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            may collect information such as pages visited, timestamps, referral sources,
            browser and device details, approximate location, IP addresses, and online
            identifiers. Google processes this information to provide aggregated usage reports
            and maintain its services in accordance with its{" "}
            <a
        ...
        <section>
          ...
          <p>
            ...
            may place and read cookies on your browser or use web beacons, IP addresses, and
            other identifiers to collect information as a result of ad serving on this site.
            This information may be used to select, deliver, measure, and personalize ads,
            including based on your prior visits to this website or other websites.
          </p>
          <p className="mt-3">
            ...
            the internet. Data collected through Google advertising services may be shared
            with or processed by Google and its advertising partners. Ads may also be served
            as non-personalized ads depending on your settings, region, and consent choices.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Google explains how it collects, uses, and shares information from sites and apps
            that use Google services here:{" "}
            <a
          ...
          <p className="mt-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              business data responsibility information
            </a>
            .
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            To opt out of Google Analytics in supported browsers, you may install the{" "}
            <a
        ...
        <section>
          ...
          <p>
            Our site may use cookies and similar technologies through Google Analytics,
            Google AdSense, consent tools, and other site functionality. These technologies
            can store or access information on your device to understand site usage, improve
            pages, remember choices, prevent fraud, measure performance, and support
        ...
        <section>
          ...
          <p>
            Google tags on this site are configured with denied storage defaults until a
            consent signal is available. Before serving personalized ads to visitors in the
            European Economic Area, the United Kingdom, or Switzerland, we use a
            Google-certified consent management platform that supports the IAB Transparency
            and Consent Framework where required. Visitors can accept, reject, or manage the
            relevant data purposes in that message. If consent is not provided, advertising
            may be limited or non-personalized, and some analytics features may be restricted.
          </p>
        </section>
