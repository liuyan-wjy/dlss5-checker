...
const pages: SitemapPage[] = [
  ...
  { path: "/dlss-supported-cards", changeFrequency: "weekly", priority: 0.9 },
  { path: "/dlss-4-5-supported-cards", changeFrequency: "weekly", priority: 0.88 },
  ...
  { path: "/pt/dlss-4-5-quais-placas", changeFrequency: "weekly", priority: 0.84 },
